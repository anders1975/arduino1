...
// ---------------------------------------------------------------------------
#define MAX_MENU       	56   //maximum number of nodes (absolute supported max number of addMenu calls)
...
public:
  ...
  void     addVar(MW_TYPE, void (*f)(int), int);
...
public:
  ...
  int      freeRam();
  int      tm_usrScreen;   	//lap time before usrscreen  
